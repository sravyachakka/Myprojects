...
function add_expense(){
    var amount=document.getElementsByIdClassName("form-input")[0].value;
    var date=document.getElementsByIdClassName("form-input")[2].value;
    var note=document.getElementsByIdClassName("form-input")[3].value;
    var category=document.getElementsByIdClassName("form-input")[1].selectedIndex;
    ...
    if(amount &&  date && note && selected){
        ...
        update_sum();
        console.log(count);
        document.getElementByClassName("add-new-expense")[0].getElementsByClassName.display="none";
    }
      else{
    ...
    function add_category(){
        var new_category_value=documnent.getElementsByName("new-category")[0].value;
        if(new_category_value){
            ...
            available_categories.appendChild(new_caategory_span);
    ...
    function add_category_page(){
        if(document.getElementsByClassName("add-category")[0].style.display=="block"){
            ...
            document.getElementsByClassName("add-category")[0].style.disply="block";
        }
    }
